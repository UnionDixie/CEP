...
//	friend std::ostream& operator<< (std::ostream& is, Vector2f& vec);
//	float& x();
//	float& y();
//	float x() const;
//	float y() const;
...
//	friend std::ostream& operator<< (std::ostream& is, Rectangle& vec);
//public:
...
//		throw("invalid size to rect1"s);
//
//	if (m_size2.x() < 0 || m_size2.y() < 0)
//		throw("invalid size to rect2"s);
//
...
//}
//
//std::ostream& operator<< (std::ostream& is, Rectangle& rec)
//{
//	os << "Rec:(" << vec.m_point << "," vec.m_size << ")";
//	return os;
//}
//}
//
